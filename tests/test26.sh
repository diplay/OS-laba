...
FS_INPUT="./testdir/testwhat.BBB содержит строку «THIS IS TESTING!!!» ./testdir/testadd содержит строку «This text will be appended»"
FS_OUTPUT=""
...
FS_OUTPUT="$FS_OUTPUT ./testdir/testadd содержит строку \"$(cat testdir/testadd)\""
#Check
